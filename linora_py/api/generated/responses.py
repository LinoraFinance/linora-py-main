# Generated from linora API spec version 1.106.0
...
class BlockTradeSignature(BaseModel):
    ...
    signature_data: Annotated[
        str,
        Field(
            description='Order signature in as a string "[r,s]" signed by account\'s linora private key',
            examples=["0xabc123..."],
        ),
    ]
...
class MarketSummaryResp(BaseModel):
    ...
    mark_price: Annotated[
        str | None,
        Field(
            description="[Mark price](https://docs.linora.trade/risk-system/mark-price-calculation)",
...
class SystemConfigResponse(BaseModel):
    ...
    block_explorer_url: Annotated[
        ...
        Field(
            ...
            examples=["https://voyager.testnet.linora.trade/"],
        ),
    ] = None
    ...
    environment: Annotated[
        str | None, Field(description="Environment of the linora Instance", examples=["local"])
    ] = None
    ...
    starknet_fullnode_rpc_base_url: Annotated[
        ...
        Field(
            ...
            examples=["https://pathfinder.api.testnet.linora.trade"],
        ),
    ] = None
    starknet_fullnode_rpc_url: Annotated[
        ...
        Field(
            ...
            examples=["https://pathfinder.api.testnet.linora.trade/rpc/v0_9"],
        ),
    ] = None
...
class SystemTimeResponse(BaseModel):
    ...
    server_time: Annotated[str | None, Field(description="linora Server time", examples=["1681493415023"])] = None
...
class OrderResp(BaseModel):
    ...
    id: Annotated[
        str | None, Field(description="Unique order identifier generated by linora", examples=["123456"])
    ] = None
...
class TransferResult(BaseModel):
    ...
    txn_hash: Annotated[
        str | None,
        Field(
            description="Transaction hash on linora chain",
            examples=["0x495d2eb5236a12b8b4ad7d3849ce6a203ce21c43f473c248dfd5ce70d9454fa"],
        ),
    ] = None
...
class VaultResp(BaseModel):
    ...
    kind: Annotated[
        ...
        Field(
            description=(
                "Kind of the vault: 'user' for user-defined vaults, 'protocol' for vaults controlled by linora"
            ),
            examples=["user"],
        ),
    ] = None
