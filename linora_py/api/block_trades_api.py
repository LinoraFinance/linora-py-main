...
from linora_py.api.generated.requests import (
    BlockExecuteRequest,
    BlockOfferRequest,
    BlockTradeRequest,
)
from linora_py.api.generated.responses import (
    ApiError,
    APIResults,
...
class BlockTradesMixin:
    ...
    This mixin provides all block trades functionality to be mixed into linoraApiClient.
    """
