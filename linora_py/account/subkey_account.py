...
from linora_py.account.account import CustomStarknetChainId, linoraAccount
...
class SubkeyAccount(linoraAccount):
    ...
    def _setup_starknet_account(self):
        ...
        # Apply the same monkey patch as linoraAccount
