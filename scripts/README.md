...
This directory contains utility scripts for the linora Python SDK.

## Model Generation

### `generate_models_simple.py`

Fetches the linora API OpenAPI specification and generates Pydantic models.
...
- `--output-dir`: Output directory for generated models (default: `linora_py/api/generated`)
...
4. Outputs models to `linora_py/api/generated/` (or custom directory)
5. Cleans up temporary files

**Generated files:**

- `linora_py/api/generated/model.py` - Base models
- `linora_py/api/generated/requests.py` - Request models
- `linora_py/api/generated/responses.py` - Response models
- `linora_py/api/generated/__init__.py` - Package initialization
