#!/usr/bin/env python3
"""
Simple script to fetch linora API OpenAPI spec and generate Pydantic models.

This script:
1. Fetches the Swagger 2.0 spec from linora API OR uses a provided JSON file
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Pydantic models from linora API spec")
    parser.add_argument(
        "--spec-file",
        type=str,
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="linora_py/api/generated",
        help="Output directory for generated models (default: linora_py/api/generated)",
    )

    args = parser.parse_args()

    api_url = "https://api.prod.linora.trade/swagger/doc.json"
    ...
    try:
        ...
        gen_cmd = [
            ...
            "--use-subclass-enum",
            "--custom-file-header",
            f"# Generated from linora API spec version {api_version}",
        ]
        ...
        if "from .model import *" not in init_content:
            init_file.write_text(
                f"# Generated from linora API spec version {api_version}\n\n"
                f'"""Generated API models from linora OpenAPI spec v{api_version}."""\n\n'
                "# ruff: noqa: F403, A003\n"
